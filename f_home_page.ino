 ...
 return  "<!DOCTYPE html> \
      ...
      <body> \
          ...
          <div class='container'> \
              <div> \
                  <p>Chord length:</p> \
                  <input type='number' name='chord' id='chord'> \
              </div> \
              <div> \
                  <p>Radius:</p> \
                   \
              ...
              <div> \
                  <p>Blodes number:</p> \
                  <input type='number' name='blodes' id='blodes'> \
              </div> \
              <div> \
                  <p>Solidity:</p> \
                  <input type='number' name='solidity' id='solidity' readonly> \
              </div> \
          </div> \
          ...
          <div class='fix-point'> \
               \
                  <p>Fix Mode</p> \
                  <input type='checkBox' id = 'fix-mode-box' > \
           \
          </div> \
               \
          <div class='container'> \
              ...
              <div> \
                  <p>Ω:</p> \
                  <input type='number' name='omegaMaj' id='omegaMaj' readonly> \
              </div> \
              <div> \
                  <p>α<sub>r</sub>:</p> \
                  <input type='number' name='alpha' id='alpha' readonly> \
              </div> \
              <div> \
              <p>ω<sub>r</sub>:</p> \
                  <input type='number' name='omega' id='omega' readonly> \
              </div> \
          </div> \
